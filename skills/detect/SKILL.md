---
name: find-objects
description: Find objects in an image and show the user an annotated copy with boxes drawn on it. Use whenever the user wants to detect, find, count, locate or identify objects in a photo or image, asks what is in an image, or asks which object detection model to use. Runs locally, nothing is uploaded.
---
